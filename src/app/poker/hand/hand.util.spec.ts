...
fdescribe('HandUtil.isStraight', () => {
  ...
  it('givenRoyalFlush_whenIsStraight_thenTrue', () => expect(HandUtil.isStraight(flush)).toBeTruthy());
  it('givenStraightFlush_whenIsStraight_thenTrue', () => expect(HandUtil.isStraight(flush)).toBeTruthy());
});
